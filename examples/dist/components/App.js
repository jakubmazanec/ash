	...
	_createClass(App, [{
   	...
   	<List label="List1" list={list1Store.get()} shadow={appStore.get().get('list1Shadow')} changeShadow={this.changeList1Shadow} />
			...
			return _ash2.default.createElement(
				...
				_ash2.default.createElement(_List2.default, { label: 'List1', list: _storesList1Store2.default.get(), shadow: _storesAppStore2.default.get().get('list1Shadow'), changeShadow: this.changeList1Shadow }),
				_ash2.default.createElement(_List2.default, { label: 'List2', list: _storesList2Store2.default.get(), shadow: _storesAppStore2.default.get().get('list2Shadow'), changeShadow: this.changeList2Shadow })
			);
		}
	}, {
		key: 'onMount',
