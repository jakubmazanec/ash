...
var App = (function (_ash$Component) {
	...
	_createClass(App, [{
   	...
   	<List label="List1" list={list1Store.get()} shadow={appStore.get().get('list1Shadow')} changeShadow={this.changeList1Shadow} />
			...
			return _ash2.default.createElement('div', null, _ash2.default.createElement('div', { style: {
					boxShadow: _storesAppStore2.default.get().get('appShadow') ? '2px 2px 5px red' : '2px 2px 5px blue'
				} }, _ash2.default.createElement('button', { events: {
					// click: this.addToList1
					click: this.list1.update.bind(null, 1)
				} }, '+ list 1!'), _ash2.default.createElement('button', { events: {
					click: this.addToList2
				} }, '+ list 2!'), _ash2.default.createElement('button', { events: {
					click: this.clearList1
				} }, '+ clear 1!'), _ash2.default.createElement('button', { events: {
					click: this.clearList2
				} }, '+ clear 2!'), _ash2.default.createElement('button', { events: {
					click: this.changeShadow
				} }, '!!!')), _ash2.default.createElement(_List2.default, { label: 'List1', list: _storesList1Store2.default.get(), shadow: _storesAppStore2.default.get().get('list1Shadow'), changeShadow: this.changeList1Shadow }), _ash2.default.createElement(_List2.default, { label: 'List2', list: _storesList2Store2.default.get(), shadow: _storesAppStore2.default.get().get('list2Shadow'), changeShadow: this.changeList2Shadow }));
		}
	}, {
		key: 'onMount',
