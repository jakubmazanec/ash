...
function asDeepMutable(obj) {
	if (!obj || !obj.hasOwnProperty(immutabilityTag)) {
		return obj;
	}
...
function merge(arg) {
	...
	function addToResult(currentObj, otherObj, key) {
		...
		anyChanges = anyChanges || (!currentObj.hasOwnProperty(key) || immutableValue !== currentObj[key] && immutableValue === immutableValue);
	...
	if (!receivedArray && arguments.length === 1) {
		...
		var others = receivedArray ? arg : Array.prototype.slice.call(arguments);
